          ...
          <ImageBackground source={require('../../assets/com_back_5.gif')} style={{ flex: 1 }}>
            ...
            <View style={styles.streamContainer}>
              <View style={styles.streamOnePortrait}>
                <View>{this.renderNodePlayerView(this.state.inputUrlFirst)}</View>
              </View>
              <View style={styles.streamTwoPortrait}>
                <View>{this.renderNodePlayerView(this.state.inputUrlSecond)}</View>
              </View>
            </View>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                this.scroll.scrollTo({ x: this.xOffset - screenWidth / 2 });
              }}
            >
